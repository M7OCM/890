...
TEMPORARILY WITHDRAWN FOR AGC MODE/REG EDIT BUG FIX 2.0.5 26012024 single binary, squelch threshold revision; based on data gleaned from various UV-K5 firmware sources. Credit: Xawen/OEFWCOM
