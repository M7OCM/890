...
LIST_FREQSTEP = ["0.01K", "0.25K", "1.25K", "2.5K", "5K", "6.25K", "8.33K", "10K", "12.5K",
...
LIST_SKEY = ["None", "Monitor", "Frequency Detect", "Talkaround",
             ...
             "Send Tone", "Roger Beep", "FM Radio", "Freq Scanner"]
...
class IradioUV5118plus(chirp_common.CloneModeRadio):
    ...
    VALID_BANDS = [(18000000, 136000000),  # RX only (Air Band)
    ...
    def get_features(self):
        ...
        rf.valid_modes = ["NFM", "FM", "AM", "LSB", "USB"]
    ...
    def get_memory(self, number):
        ...
        if _mem.isnarrow:
            ...
            mem.mode = ["FM", "AM", "LSB", "USB"][_mem.modulation_type]
    ...
    def set_memory(self, mem):
        ...
        # If mode is not NFM, write the index (0,1,2,3) of the remaining options into modulation_type
        if mem.mode != "NFM":
            _mem.modulation_type = ["FM", "AM", "LSB", "USB"].index(mem.mode)
